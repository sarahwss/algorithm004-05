...
class Solution_8 {
    ...
    public int myAtoi(String s) {
        ...
        for (; j < n; j++) {
            ...
            // 这里别忘了减0
            int d = c - '0';
            // 正数即将溢出，注意这里的判断条件，不要用乘法和加法
            if (flag == 1 && (Integer.MAX_VALUE / 10 < res || (Integer.MAX_VALUE - d) / 10 < res)) {
                return Integer.MAX_VALUE;
            }
            // 负数即将溢出，注意这里的判断条件，不要用乘法和加法
            if (flag == -1 && (Integer.MIN_VALUE / 10 > -res || (Integer.MIN_VALUE + d) / 10 > -res)) {
